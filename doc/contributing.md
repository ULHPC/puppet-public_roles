...
# Public_roles Puppet Module Developments
...
### Directory Layout
       ...
       ULHPC-public_roles/       # Main directory 
           ...
           `-- manifests/
                ...
                `-- classes/     # Hold manifest for ULHPC-public_roles classes/
                     `-- ULHPC-public_roles.pp         # defines the ULHPC-public_roles class
                     `-- ULHPC-public_roles-params.pp  # ULHPC-public_roles module variables 
                `-- definitions/ # Hold manifest for ULHPC-public_roles definitions
                     `-- ULHPC-public_roles-mydef.pp   # defines the ULHPC-public_roles::mydef definition   `-- templates/        # Module ERB template files
